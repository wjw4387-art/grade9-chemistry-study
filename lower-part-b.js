    ...
    "lessons": [
      {
        ...
        "questions": [
          ...
          },
          {
            "type": "choice",
            "difficulty": 3,
            "stem": "18 g葡萄糖在体内经酶催化完全氧化，总反应按C₆H₁₂O₆＋6O₂＝6CO₂＋6H₂O（酶催化），消耗O₂多少g？",
            "options": [
              "19.2",
              "18",
              "26.4",
        ...
        "estimatedMinutes": 16,
        "example": "例题：一盒奶250mL，标签写每100mL含蛋白质3.2g、钙120mg。整盒蛋白质为3.2×2.5＝8.0g，钙为120×2.5＝300mg。若另一种片剂含0.75g CaCO₃，钙元素质量分数为40÷100＝40%，理论含钙0.75×40%＝0.30g＝300mg。两者理论钙含量相同，并不代表吸收率、适宜用量或营养价值完全相同。再看体内葡萄糖氧化的总反应：C₆H₁₂O₆＋6O₂＝6CO₂＋6H₂O（酶催化），180g葡萄糖对应192g氧气；人体内的过程由复杂生化反应逐步完成，方程式只表达总的物质关系。",
        "term": "lower"
      },
      {
        "id": "u11-2a",
...
export const lowerDetailsB = {
  ...
  "u10-3c": {
    ...
    "method": "看化学式先圈出 N、P、K，再判断肥料类别。计算含氮量按“式量中全部氮原子的相对质量之和÷式量”，再乘样品质量和必要的纯度。检验铵盐可在教师指导下与碱混合适当加热，产生的 NH₃ 能使湿润红色石蕊试纸变蓝；不能把鼻子贴近闻。检验时可用NH₄Cl＋NaOH＝NaCl＋NH₃↑＋H₂O（加热）表示。铵态氮肥与碱性物质混用也可能造成氨的挥发损失；实验室检验条件与土壤中实际过程要分别说明。制定施肥方案还需考虑养分能否被吸收、土壤本底和流失，不能把理论含量高直接等同于实际更好。",
  ...
  "u11-1": {
    ...
    "worked": "例题：一盒奶250mL，标签写每100mL含蛋白质3.2g、钙120mg。整盒蛋白质为3.2×2.5＝8.0g，钙为120×2.5＝300mg。若另一种片剂含0.75g CaCO₃，钙元素质量分数为40÷100＝40%，理论含钙0.75×40%＝0.30g＝300mg。两者理论钙含量相同，并不代表吸收率、适宜用量或营养价值完全相同。再看体内葡萄糖氧化的总反应：C₆H₁₂O₆＋6O₂＝6CO₂＋6H₂O（酶催化），180g葡萄糖对应192g氧气；人体内的过程由复杂生化反应逐步完成，方程式只表达总的物质关系。",
    "sections": [
      {
