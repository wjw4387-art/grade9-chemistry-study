...
export const courses = [
  {
    ...
    async load(){
      const [a,b,c,review]=await Promise.all([import('./physics/grade8-upper.js'),import('./physics/grade8-lower.js'),import('./physics/grade9.js'),import('./physics/question-refinements.js')]);
