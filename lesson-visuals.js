...
function special(id){
if(id==='u2-1')return `<svg class="lesson-diagram" viewBox="0 0 760 220" role="img" aria-label="空气体积组成示意：氮气约78%，氧气约21%，其他气体约1%"><text x="46" y="46" font-size="23" font-weight="700" fill="#15364e">空气体积组成（近似）</text><rect x="45" y="78" width="515" height="72" rx="11" fill="#dde8ee"/><path d="M56 78h391v72H56q-11 0-11-11V89q0-11 11-11" fill="#7eb5d2"/><rect x="447" y="78" width="108" height="72" fill="#f1bd67"/><text x="244" y="123" text-anchor="middle" font-size="24" fill="#15364e">氮气 ≈ 78%</text><text x="500" y="123" text-anchor="middle" font-size="22" fill="#15364e">氧气 ≈ 21%</text><path d="M562 78v72" stroke="#497182" stroke-width="4"/><text x="577" y="99" font-size="18" fill="#15364e">其他约 1%</text><text x="45" y="196" font-size="18" fill="#5b7585">表示体积分数，不是质量分数</text></svg>`;
if(id==='u3-1')return `<svg class="lesson-diagram" viewBox="0 0 760 220" role="img" aria-label="化学变化中分子可分，原子重新组合：两个氢分子与一个氧分子生成两个水分子"><text x="38" y="39" font-size="22" font-weight="700" fill="#15364e">化学变化：原子重新组合</text><circle cx="86" cy="109" r="17" fill="#9ac7e7"/><circle cx="120" cy="109" r="17" fill="#9ac7e7"/><circle cx="182" cy="109" r="17" fill="#9ac7e7"/><circle cx="216" cy="109" r="17" fill="#9ac7e7"/><text x="146" y="119" font-size="28">+</text><circle cx="296" cy="109" r="23" fill="#eeaa91"/><circle cx="342" cy="109" r="23" fill="#eeaa91"/><path d="M386 109h80" stroke="#5a798c" stroke-width="4"/><path d="M466 109l-13-9v18Z" fill="#5a798c"/><circle cx="525" cy="105" r="22" fill="#eeaa91"/><circle cx="504" cy="138" r="15" fill="#9ac7e7"/><circle cx="546" cy="138" r="15" fill="#9ac7e7"/><text x="575" y="119" font-size="28">+</text><circle cx="654" cy="105" r="22" fill="#eeaa91"/><circle cx="633" cy="138" r="15" fill="#9ac7e7"/><circle cx="675" cy="138" r="15" fill="#9ac7e7"/><text x="70" y="193" font-size="19" fill="#15364e">蓝：氢原子　橙：氧原子　反应前后原子种类和数目相同</text></svg>`;
if(id==='u4-3')return `<svg class="lesson-diagram" viewBox="0 0 760 220" role="img" aria-label="化学式H2O中下标2表示一个水分子中有两个氢原子；系数2H2O表示两个水分子"><text x="67" y="68" font-size="35" font-weight="700" fill="#15364e">H₂O</text><path d="M101 81v35h130" fill="none" stroke="#d99b4d" stroke-width="3"/><text x="238" y="124" font-size="20" fill="#15364e">下标 2：每个水分子含 2 个氢原子</text><text x="67" y="182" font-size="35" font-weight="700" fill="#15364e">2H₂O</text><path d="M87 171v-31h140" fill="none" stroke="#57a99b" stroke-width="3"/><text x="238" y="153" font-size="20" fill="#15364e">系数 2：有 2 个水分子</text></svg>`;
